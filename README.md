...
* Closer to the user's thumb — minimises user efforts and perceived time spent  
...
3. Happy path only — assumed sufficient for the challenge (sad paths can be added later)  
4. Retry queues for API persistence were omitted — can be added later if needed  

### 🎨 Approach: Design Process
* Broke down task into Acceptance Criteria, see (Acceptance Criteria section below)
* Drafted on whiteboard (see Figure 1)
* Browsed the internet and popular health and fitness apps for inspiration (see Figure 2)
* Designed screen by screen (see Figure 3)
...
2. Some parts were built in a scrappy, fast way to demonstrate the ability to move quickly  
3. Having worked in startups, the need to balance speed with quality has been deeply understood  
4. The balance between quality and speed varies depending on product maturity, feature priority, company lifecycle, and risk tolerance  
...
* No integration tests were written — in other projects, more tests, including Integration tests, would be expected  
  _(See example from an older poject: [Stocks repo](https://github.com/Tak783/Stocks))_  
